...
var pacerModule = (function () {
  ...
  var tabModules = [tiltModule, joystickModule, pressureModule, graphModule, consoleModule];
  var activeTab = 2;
  var messageId = 0;
  ...
  function setEnabled() {
    if (websocketModule.connected())
    {
      ...
      $("#btnenable").removeClass("btn-secondary").removeClass("btn-danger").addClass("btn-success");
  ...
  function setDisabled() {
    ...
    if (websocketModule.connected())
    {
      $("#btnenable").removeClass("btn-secondary").removeClass("btn-success").addClass("btn-danger");
      $("#btnenable").text("Disabled");
    }
    else
    {
      $("#btnenable").removeClass("btn-danger").removeClass("btn-success").addClass("btn-secondary");
  ...
  function connectChange(connected)
  {
    if (connected)
    {
      ...
      $("#btnenable").removeClass("btn-secondary").addClass("btn-danger");
      $("#btnenable").text("Disabled");
    }
    else
    {
